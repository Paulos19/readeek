...
export default function Header() {
  ...
  return (
    <>
      {/* ======================= NOVO HEADER MOBILE ======================= */}
      <header className="md:hidden fixed top-0 left-0 right-0 z-50 p-4 flex items-center justify-between pointer-events-none">
        <Link href="/" className="pointer-events-auto">
          {/* O logo aparece aqui, fixo no topo */}
          <ReadeekLogo />
        </Link>
        {/* Adicione aqui outros ícones mobile se desejar, como notificações */}
      </header>
